...
class MiniMaxOpening:
	...
	def countMills(self, board):
		...
		return numWhiteCloseMills, numBlackCloseMills, numPotWhiteCloseMills, numPotBlackCloseMills
	...
	def staticMidGame(self, board):
		...
		numWhiteCloseMills, numBlackCloseMills, numPotWhiteCloseMills, numPotBlackCloseMills = self.countMills(board)
