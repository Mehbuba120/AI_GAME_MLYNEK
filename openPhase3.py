...
class MiniMaxOpening:
	...
	def MinMax(self, x, alpha, beta):
		...
		v = 50000 - depth               #prioritize moves at shallower depths
		if depth <= 18:
			...
			children = sorted(children, key=self.staticMidGame)         # improve pruning efficiency 
	...
	def MaxMin(self, x, alpha, beta):
		...
		v = -50000 + depth              #nodes at deeper depths have different scores than nodes at shallower depths.
		if depth <= 18:
